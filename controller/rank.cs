...
namespace SQLCRACKER {
    public partial class rank : Form {
        ...
        private void Ranking_Load(object sender, EventArgs e) {
            ...
            labelChoice.Text=(userData.CurrentSelectionStage-1).ToString();
            string sql = "SELECT row_number() over(order by stage desc) 排名,user_name 用户名,stage 关卡数,coin 金钱,current_selection_stage 训练题数 FROM user";
